...
//PokeRide Species (Done separately to fix HP bug)
#define SPECIES_BELLSPROUT_RIDE 0x4FA //Cut
#define SPECIES_SEAKING_RIDE 0x4FB //Surf, Whirlpool, Waterfall and Dive
#define SPECIES_MACHOKE_RIDE 0x4FC //Rock Smash, Strenght and Rock Climb
#define SPECIES_ABRA_RIDE 0x4FD //Flash
#define SPECIES_PIDGEOT_RIDE 0x4FE //Fly and Defog

//G-Max
#define SPECIES_VENUSAUR_GIGA 0x4FF
#define SPECIES_CHARIZARD_GIGA 0x500
#define SPECIES_BLASTOISE_GIGA 0x501
#define SPECIES_BUTTERFREE_GIGA 0x502
#define SPECIES_PIKACHU_GIGA 0x503
#define SPECIES_MEOWTH_GIGA 0x504
#define SPECIES_MACHAMP_GIGA 0x505
#define SPECIES_GENGAR_GIGA 0x506
#define SPECIES_KINGLER_GIGA 0x507
#define SPECIES_LAPRAS_GIGA 0x508
#define SPECIES_EEVEE_GIGA 0x509
#define SPECIES_SNORLAX_GIGA 0x50A
#define SPECIES_GARBODOR_GIGA 0x50B
#define SPECIES_MELMETAL_GIGA 0x50C
#define SPECIES_RILLABOOM_GIGA 0x50D
#define SPECIES_CINDERACE_GIGA 0x50E
#define SPECIES_INTELEON_GIGA 0x50F
#define SPECIES_CORVIKNIGHT_GIGA 0x510
#define SPECIES_ORBEETLE_GIGA 0x511
#define SPECIES_DREDNAW_GIGA 0x512
#define SPECIES_COALOSSAL_GIGA 0x513
#define SPECIES_FLAPPLE_GIGA 0x514
#define SPECIES_APPLETUN_GIGA 0x515
#define SPECIES_SANDACONDA_GIGA 0x516
#define SPECIES_TOXTRICITY_GIGA 0x517
#define SPECIES_TOXTRICITY_LOW_KEY_GIGA 0x518
#define SPECIES_CENTISKORCH_GIGA 0x519
#define SPECIES_HATTERENE_GIGA 0x51A
#define SPECIES_GRIMMSNARL_GIGA 0x51B
#define SPECIES_ALCREMIE_GIGA 0x51C
#define SPECIES_COPPERAJAH_GIGA 0x51D
#define SPECIES_DURALUDON_GIGA 0x51E
#define SPECIES_URSHIFU_SINGLE_GIGA 0x51F
#define SPECIES_URSHIFU_RAPID_GIGA 0x520
