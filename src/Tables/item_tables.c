...
const struct FlingStruct gFlingTable[ITEMS_COUNT] =
{
	...
	[ITEM_RED_MINT] = {30, MOVE_EFFECT_ATK_MINUS_2},
	[ITEM_BLUE_MINT] = {30, MOVE_EFFECT_DEF_MINUS_2},
	[ITEM_AZURE_MINT] = {30, MOVE_EFFECT_SP_ATK_MINUS_2},
	[ITEM_ROSEATE_MINT] = {30, MOVE_EFFECT_SP_DEF_MINUS_2},
	[ITEM_GREEN_MINT] = {30, MOVE_EFFECT_SPD_MINUS_2},
	[ITEM_YELLOW_MINT] = {30, MOVE_EFFECT_ACC_MINUS_2},
#ifdef UNBOUND
...
const u16 gItemsByType[ITEMS_COUNT] =
{
	...
	[ITEM_RED_MINT] = ITEM_TYPE_SELLABLE,
	[ITEM_BLUE_MINT] = ITEM_TYPE_SELLABLE,
	[ITEM_AZURE_MINT] = ITEM_TYPE_SELLABLE,
	[ITEM_ROSEATE_MINT] = ITEM_TYPE_SELLABLE,
	[ITEM_GREEN_MINT] = ITEM_TYPE_SELLABLE,
	[ITEM_YELLOW_MINT] = ITEM_TYPE_SELLABLE,
