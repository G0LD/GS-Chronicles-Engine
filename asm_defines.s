...
.equ MOVE_BREAKNECK_BLITZ_P, 0x30A
.equ MOVE_BREAKNECK_BLITZ_S, 0x30B
.equ MOVE_ALL_OUT_PUMMELING_P, 0x30C
.equ MOVE_ALL_OUT_PUMMELING_S, 0x30D
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x30E
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x30F
.equ MOVE_ACID_DOWNPOUR_P, 0x310
.equ MOVE_ACID_DOWNPOUR_S, 0x311
.equ MOVE_TECTONIC_RAGE_P, 0x312
.equ MOVE_TECTONIC_RAGE_S, 0x313
.equ MOVE_CONTINENTAL_CRUSH_P, 0x314
.equ MOVE_CONTINENTAL_CRUSH_S, 0x315
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x316
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x317
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x318
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x319
.equ MOVE_CORKSCREW_CRASH_P, 0x31A
.equ MOVE_CORKSCREW_CRASH_S, 0x31B
.equ MOVE_INFERNO_OVERDRIVE_P, 0x31C
.equ MOVE_INFERNO_OVERDRIVE_S, 0x31D
.equ MOVE_HYDRO_VORTEX_P, 0x31E
.equ MOVE_HYDRO_VORTEX_S, 0x31F
.equ MOVE_BLOOM_DOOM_P, 0x320
.equ MOVE_BLOOM_DOOM_S, 0x321
.equ MOVE_GIGAVOLT_HAVOC_P, 0x322
.equ MOVE_GIGAVOLT_HAVOC_S, 0x323
.equ MOVE_SHATTERED_PSYCHE_P, 0x324
.equ MOVE_SHATTERED_PSYCHE_S, 0x325
.equ MOVE_SUBZERO_SLAMMER_P, 0x326
.equ MOVE_SUBZERO_SLAMMER_S, 0x327
.equ MOVE_DEVASTATING_DRAKE_P, 0x328
.equ MOVE_DEVASTATING_DRAKE_S, 0x329
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x32A
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x32B
.equ MOVE_TWINKLE_TACKLE_P, 0x32C
.equ MOVE_TWINKLE_TACKLE_S, 0x32D

.equ MOVE_CATASTROPIKA, 0x32E
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x32F
.equ MOVE_STOKED_SPARKSURFER, 0x330 
.equ MOVE_EXTREME_EVOBOOST, 0x331 
.equ MOVE_PULVERIZING_PANCAKE, 0x332
.equ MOVE_GENESIS_SUPERNOVA, 0x333
.equ MOVE_SINISTER_ARROW_RAID, 0x334
.equ MOVE_MALICIOUS_MOONSAULT, 0x335
.equ MOVE_OCEANIC_OPERETTA, 0x336
.equ MOVE_SPLINTERED_STORMSHARDS, 0x337 
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x338
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x339
.equ MOVE_GUARDIAN_OF_ALOLA, 0x33A
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x33B
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x33C
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x33D
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x33E
