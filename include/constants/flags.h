...
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAZZ_BERRY               90//Red Mint Route 42 Meadow - Rare
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_BLUK_BERRY               91//Yellow Mint Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_NANAB_BERRY              92//Blue Mint Route 42 Meadow - Rare
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_WEPEAR_BERRY             93//Ylw Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ORAN_BERRY               94//Blk Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHERI_BERRY              95//Wht Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_CHESTO_BERRY             96//Green Mint Route 42 Meadow - Rare
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PECHA_BERRY              97//Azure Mint Route 42 Meadow - Rare
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_RAWST_BERRY              98//Green Mint Route 42 Meadow - Rare
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_ASPEAR_BERRY             99//Blu Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PERSIM_BERRY            100//Grn Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_PINAP_BERRY             101//Pnk Apricorn Route 42 Meadow - Uncommon
#define HIDDEN_ITEM_THREE_ISLAND_BERRY_FOREST_LUM_BERRY               102//Red Apricorn Route 42 Meadow - Uncommon
...
#define FLAG_BADGE01_GET 0x20E
#define FLAG_BADGE02_GET 0x9B0
#define FLAG_BADGE03_GET 0x956
#define FLAG_BADGE04_GET 0x960
#define FLAG_BADGE05_GET 0x9B1
#define FLAG_BADGE06_GET 0x9B2
#define FLAG_BADGE07_GET 0x9B3
#define FLAG_BADGE08_GET 0x9B5
