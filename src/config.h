...
#define VAR_BATTLE_BG 0x40F7 //Set this var to a custom background id
...
/*===== General Flags =====*/
#define FLAG_INVERSE 0x1400 //Set this flag for all battles to become Inverse Battles
#define FLAG_SKY_BATTLE 0x1401 //Set this flag to indicate the Sky Battle rules should be followed in the next battle.
#define FLAG_NO_CATCHING 0x1402 //The player cannot catch Pokemon in battles when this flag is set
#define FLAG_NO_RUNNING 0x1403 //The player cannot run in battles when this flag is set
#define FLAG_NO_CATCHING_AND_RUNNING 0x1404 //The player cannot run or catch Pokemon in battles when this flag is set
#define FLAG_CATCH_TRAINERS_POKEMON 0x1405 //Setting this flag will allow you to capture trainers' pokemon. Comment this line to remove this feature
#define FLAG_EXP_SHARE 0x1406 //Used to indicate if the Gen 6+ Exp Share is enabled
#define FLAG_DOUBLE_BATTLE 0x1407 //Setting this flag will automatically trigger a double battle if possible
#define FLAG_TAG_BATTLE 0x1408 //This flag is set by the engine when trainerbattle 0x10 is used to activate a tag battle
#define FLAG_TWO_OPPONENTS 0x1409 //This flag is set by the engine when trainerbattle 0x11 is used to activate a dual opponent battle
#define FLAG_ACTIVATE_TUTORIAL 0x140A //Setting this flag will allow you to activate Oak's tutorial in any kind of battle (including doubles). Comment this line to remove this feature
#define FLAG_WILD_CUSTOM_MOVES 0x140B //Setting this flag lets you assign wild Pokemon custom moves
#define FLAG_SMART_WILD 0x140C //Set this flag is you don't want wild Pokemon to act randomly (useful for one time smarter wild battles). This is cleared at the end of the battle.
#define FLAG_SCALE_WILD_POKEMON_LEVELS 0x140D //If this flag is set, all random wild Pokemon (other than scripted ones) will have their level scaled to the lowest level in the player's party
#define FLAG_SCALE_TRAINER_LEVELS 0x140E //If this flag is set, all Trainer Pokemon levels will be set to the highest in your party
#define FLAG_HIDDEN_ABILITY 0x140F //If this flag is set, generated wild Pokemon will have their hidden abilities
#define FLAG_GIGANTAMAXABLE 0x1428 //If this flag is set, generated wild and gift Pokemon will have their Gigantamax bit set
#define FLAG_DOUBLE_WILD_BATTLE 0x1410 //If this flag is set, a wild battles will be against two Pokemon
#define FLAG_NO_RANDOM_WILD_ENCOUNTERS 0x1411 //If this is set, wild Pokemon won't appear when walking/surfing in grass, caves, water, etc.
#define FLAG_REMOVE_EVO_ITEM 0x1412  //Flag to toggle item removal after leveling up (set by the engine)
#define FLAG_SHINY_CREATION 0x1413 //Flag to cause next battle to be against a shiny Pokemon
#define FLAG_AUTO_RUN 0x1414 //Flag to enable auto-run (toggled by L-button). If this feature is used, L=A will not work. Comment out this line for it to work again.
...
#define FLAG_BIKE_TURBO_BOOST 0x141F //The bike moves extra fast if this flag is set or if the player holds B.
#define FLAG_SURF_TURBO_BOOST 0x1429 //The Surf blob moves extra fast if set
#define FLAG_DISABLE_BAG 0x1415 //The bag can't be used in-battle if this flag is set
#define FLAG_MOVE_RELEARNER_IGNORE_LEVEL 0x1416 //When set, the move relearner shows all level-up moves up to MAX_LEVEL
#define FLAG_EGG_MOVE_RELEARNER 0x1417 //When set, the move learner loads egg moves instead
#define FLAG_DYNAMAX_BATTLE 0x1418 //When set, Pokemon can Dynamax in battle
#define FLAG_RAID_BATTLE 0x1419 //When set, wild Pokemon will appear Dynamaxed and be fought Raid Battle style.
#define FLAG_RAID_BATTLE_NO_FORCE_END 0x141A //When set, if FLAG_RAID_BATTLE is set, then raid battles won't be force ended.
#define FLAG_FAST_BATTLE_MESSAGES 0x1425 //When set, battle messages have no wait time once they've completed printing
#define FLAG_FOLLOWER_IGNORE_ACTIVE_SCRIPT 0x1426 //If set, the follower will reappear and move even when a script is in progress
...
#define FLAG_SYS_PLAYER_HIDE 0x141C	//Toggle [player] off
#define FLAG_SYS_SAVE_HIDE 0x141D	//Toggle save off
#define FLAG_SYS_DEXNAV 0x141E		//Flag to turn dexnav on/off in start menu (if undefined, this will eliminate dexnav from the start menu)

/*===== Pedometer Flags as in JPAN Engine =====*/
#define FLAG_LONG_PEDOMETER 0x1420		//32 bit / 4 bytes / Max 4 294 967 295 steps
#define FLAG_MED_PEDOMETER 0x1421		//16 bit / 2 bytes / Max 65 535 steps
#define FLAG_SMALL_PEDOMETER_1 0x1422	//8 bit  / 1 byte  / Max 255 steps
#define FLAG_SMALL_PEDOMETER_2 0x1423	//8 bit  / 1 byte  / Max 255 steps

/*===== Battle Tower Options =====*/
#define FLAG_BATTLE_FACILITY 0x1430
...
#define FLAG_LOAD_MUGSHOT_SPRITE_FROM_TABLE 0x1424 //Load custom mugshot for pre-battle transition
...
/*=====Randomizer Options=====*/
#define FLAG_POKEMON_RANDOMIZER 0x1440 //Setting randomizes Pokemon species that are created.
#define FLAG_POKEMON_LEARNSET_RANDOMIZER 0x1441 //Setting randomizes Pokemon learnsets.
#define FLAG_ABILITY_RANDOMIZER 0x1442 //Setting randomizes Pokemon abilities.
...
#define TRAINER_CLASS_POKE_BALLS //Comment this line to disable creating Trainer's pokemon with Poke Balls specific to their trainer class/#define TRAINERS_WITH_EVS //Uncomment this line to enable the Trainers with EVs hack, (only avaible with custom moveset and held item)
...
#define FLAG_IN_BATTLE_TEAM_PREVIEW 0x1406 //0x142B Enables or disables the Team Preview trigger button
#define FLAG_ALWAYS_SHOW_LAST_BALL 0x1406 //0x142C Enables or disables the last Pokeball used trigger button
