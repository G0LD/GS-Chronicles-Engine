...
const struct TrainerMonNoItemDefaultMoves sParty_dummy[] = {
    {
        .iv = 0,
        .lvl = 5,
...
const struct TrainerMonItemCustomMoves sParty_LeaderSurge1[] = {
    ...
    },
    {
        .iv = 0,
        .lvl =83,
        .heldItem = ITEM_RAICHUNITEX,
        .species = SPECIES_RAICHU,//M-Raichu X
        .moves = {
            MOVE_VOLTTACKLE,
            MOVE_IRONTAIL,
            MOVE_NUZZLE,
...
const struct TrainerMonItemCustomMoves sParty_LeaderSurge2[] = {
    ...
    },
    {
        .iv = 0,
        .lvl =93,
        .heldItem = ITEM_RAICHUNITEY,
        .species = SPECIES_RAICHU,//M-Raichu Y
        .moves = {
            MOVE_ZAPCANNON,
            MOVE_SURF,
            MOVE_FAKEOUT,
...
const struct TrainerMonItemCustomMoves sParty_PkmnTrainerBruno[] = {
    {
        .iv = 0,
        .lvl =80,
        .heldItem = ITEM_LEFTOVERS,
...
const struct TrainerMonItemCustomMoves sParty_BlueTagTeam[] = {
    {
        .iv = 0,
        .lvl =79,
        .heldItem = ITEM_FOCUS_BAND,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt46[] = {
    {
        .iv = 0,
        .lvl = 75,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt47[] = {
    {
        .iv = 0,
        .lvl = 75,
        .species = SPECIES_MURKROW,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt48[] = {
    {
        .iv = 0,
        .lvl = 76,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt49[] = {
    {
        .iv = 0,
        .lvl = 75,
        .species = SPECIES_HOUNDOOM,
...
const struct TrainerMonItemCustomMoves sParty_AdminBerkel3[] = {
    {
        .iv = 130,
        .lvl = 80,
        .heldItem = ITEM_BRIGHT_POWDER,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt50[] = {
    {
        .iv = 0,
        .lvl = 75,
        .species = SPECIES_THIEVUL,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt51[] = {
    {
        .iv = 0,
        .lvl = 75,
...
const struct TrainerMonNoItemDefaultMoves sParty_RocketGrunt52[] = {
    {
        .iv = 0,
        .lvl = 75,
        .species = SPECIES_DONPHAN,
...
const struct TrainerMonItemCustomMoves sParty_ExecutiveProton4[] = {
    {
        .iv = 0,
        .lvl = 79,
        .heldItem = ITEM_FOCUS_SASH,
...
const struct TrainerMonItemCustomMoves sParty_LeaderErika1[] = {
    {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_SHUCA_BERRY,
    ...
    },
    {
        ...
        .species = SPECIES_VICTREEBEL, //M-Victreebel
        .moves = {
            MOVE_SLUDGEWAVE,
            MOVE_ENERGYBALL,
            MOVE_GROWTH,
...
const struct TrainerMonItemCustomMoves sParty_LeaderErika2[] = {
    {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_LIFE_ORB,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBrock1[] = {
       {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_FOCUS_SASH,
    ...
    },
    {
        ...
        .species = SPECIES_BARBARACLE, //M-Barbaracle
        .moves = {
            MOVE_STONEEDGE,
            MOVE_SHELLSMASH,
            MOVE_CLOSECOMBAT,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBrock2[] = {
       {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_LEFTOVERS,
...
const struct TrainerMonItemCustomMoves sParty_LeaderMisty1[] = {
       {
        .iv = 0,
        .lvl =78,
    ...
    },
    {
        .iv = 0,
        .lvl =83,
        .heldItem = ITEM_STARMINITE, //ITEM_STARMINITE
        .species = SPECIES_STARMIE, //M-Starmie
        .moves = {
            MOVE_LIQUIDATION,
            MOVE_AQUAJET,
            MOVE_ZENHEADBUTT,
...
const struct TrainerMonItemCustomMoves sParty_LeaderMisty2[] = {
       {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_DAMP_ROCK,
...
const struct TrainerMonItemCustomMoves sParty_LeaderJanine1[] = {
       {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_BLACK_SLUDGE,
    ...
    },
    {
        ...
        .species = SPECIES_DRAGALGE, //M-Dragalge
        .moves = {
            MOVE_FLIPTURN,
            MOVE_DRACOMETEOR,
            MOVE_TOXIC,
...
const struct TrainerMonItemCustomMoves sParty_LeaderJanine2[] = {
        {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_LEFTOVERS,
...
const struct TrainerMonItemCustomMoves sParty_LeaderSabrina1[] = {
       {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_LEFTOVERS,
    ...
    },
    {
        ...
        .species = SPECIES_MEOWSTIC_FEMALE, //M-Meowstic
        .moves = {
            MOVE_PSYCHIC,
            MOVE_NASTYPLOT,
            MOVE_DAZZLINGGLEAM,
...
const struct TrainerMonItemCustomMoves sParty_LeaderSabrina2[] = {
       {
        .iv = 0,
        .lvl =88,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBlaine1[] = {
       {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_HEAT_ROCK,
    ...
    },
    {
        ...
        .species = SPECIES_CHANDELURE,//M-Chandelure
        .moves = {
            MOVE_FLAMETHROWER,
            MOVE_ENERGYBALL,
            MOVE_SHADOWBALL,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBlaine2[] = {
       {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_HEAT_ROCK,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBlue1[] = {
       {
        .iv = 0,
        .lvl =78,
        .heldItem = ITEM_FOCUS_SASH,
    ...
    },
    {
        .iv = 0,
        .lvl =82,
        .heldItem = ITEM_LUCARIONITEZ,
        .species = SPECIES_LUCARIO,//M-Lucario Z
        .moves = {
            MOVE_CALMMIND,
            MOVE_VACUUMWAVE,
            MOVE_AURASPHERE,
...
const struct TrainerMonItemCustomMoves sParty_LeaderBlue2[] = {
       {
        .iv = 0,
        .lvl =88,
        .heldItem = ITEM_FOCUS_SASH,
...
/*Kanto Trainer battles start here*/
    ...
    [TRAINER_PKMN_TRAINER_BRUNO] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_PKMN_TRAINER_1,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_BRUNO,
        .trainerName = {_B, _r, _u, _n, _o, _END},
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_KEYSTONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_PkmnTrainerBruno),
        .party = {.ItemCustomMoves = sParty_PkmnTrainerBruno}
    },

    [TRAINER_LORELEI_TAG_TEAM] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_PKMN_TRAINER_1,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .gender = F_TRAINER_FEMALE,
    ...
    [TRAINER_BLUE_TAG_TEAM] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_BlueTagTeam),
        .party = {.ItemCustomMoves = sParty_BlueTagTeam}
    },
    ...
    [TRAINER_TEAM_ROCKET_GRUNT_46] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt46),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt46}
    },
    ...
    [TRAINER_TEAM_ROCKET_GRUNT_47] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt47),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt47}
    },
    ...
    [TRAINER_TEAM_ROCKET_GRUNT_48] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt48),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt48}
    },
    ...
    [TRAINER_TEAM_ROCKET_GRUNT_49] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt49),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt49}
    },

    [TRAINER_ROCKET_ADMIN_BERKEL_3] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_ROCKET_ADMIN,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_BERKEL,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_AdminBerkel3),
        .party = {.ItemCustomMoves = sParty_AdminBerkel3}
    },
    [TRAINER_TEAM_ROCKET_GRUNT_50] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt50),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt50}
    },
    [TRAINER_TEAM_ROCKET_GRUNT_51] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt51),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt51}
    },
    [TRAINER_TEAM_ROCKET_GRUNT_52] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_RocketGrunt52),
        .party = {.NoItemDefaultMoves = sParty_RocketGrunt52}
    },
    [TRAINER_ROCKET_EXECUTIVE_PROTON_4] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_ROCKET_EXECUTIVE,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_PROTON,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_ExecutiveProton4),
        .party = {.ItemCustomMoves = sParty_ExecutiveProton4}
    },
    [TRAINER_LEADER_ERIKA_1] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderErika1),
        .party = {.ItemCustomMoves = sParty_LeaderErika1}
    },
    [TRAINER_LEADER_ERIKA_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderErika2),
    ...
    [TRAINER_LEADER_BROCK_1] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderBrock1),
        .party = {.ItemCustomMoves = sParty_LeaderBrock1}
    },
    [TRAINER_LEADER_BROCK_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderBrock2),
    ...
    [TRAINER_LEADER_MISTY_1] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderMisty1),
        .party = {.ItemCustomMoves = sParty_LeaderMisty1}
    },
    [TRAINER_LEADER_MISTY_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderMisty2),
        .party = {.ItemCustomMoves = sParty_LeaderMisty2}
    },
    [TRAINER_LEADER_JANINE_1] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .gender = F_TRAINER_FEMALE,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderJanine1),
        .party = {.ItemCustomMoves = sParty_LeaderJanine1}
    },
    [TRAINER_LEADER_JANINE_2] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .gender = F_TRAINER_FEMALE,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderJanine2),
        .party = {.ItemCustomMoves = sParty_LeaderJanine2}
    },
    [TRAINER_LEADER_SABRINA_1] = {//AKA my top-tier waifu ever
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .gender = F_TRAINER_FEMALE,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderSabrina1),
        .party = {.ItemCustomMoves = sParty_LeaderSabrina1}
    },
    [TRAINER_LEADER_SABRINA_2] = {//AKA mi vieja we!!!
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .gender = F_TRAINER_FEMALE,
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderSabrina2),
    ...
    [TRAINER_LEADER_BLAINE_1] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderBlaine1),
        .party = {.ItemCustomMoves = sParty_LeaderBlaine1}
    },
    [TRAINER_LEADER_BLAINE_2] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderBlaine2),
        .party = {.ItemCustomMoves = sParty_LeaderBlaine2}
    },
    [TRAINER_LEADER_BLUE_1] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_BLUE,//Need to check when I'm home which Trainer ID is
        .trainerName = {_B, _l, _u, _e, _END},
        .items = {ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE, ITEM_KEYSTONE},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_LeaderBlue1),
        .party = {.ItemCustomMoves = sParty_LeaderBlue1}
    },
    [TRAINER_LEADER_BLUE_2] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES | PARTY_FLAG_HAS_ITEM,
        .trainerClass = CLASS_LEADER_KANTO,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_BLUE,//Need to check when I'm home which Trainer ID is
    ...
    [TRAINER_CAMPER_JERRY] = {
        ...
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
        .party = {.NoItemDefaultMoves = sParty_dummy}
    },
    [TRAINER_HIKER_EDWIN] = {
        .partyFlags = 0,
        .trainerClass = CLASS_HIKER,
    ...
    [TRAINER_SAILOR_ERNIE] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SAILOR,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SAILOR,
        .trainerName = {_E, _r, _n, _i, _e, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SWIMMER_F_JOY] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SWIMMER_F,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SWIMMER_F,
        .trainerName = {_J, _o, _y, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SWIMMER_F_MOLLIE] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SWIMMER_F,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SWIMMER_F,
        .trainerName = {_M, _o, _l, _l, _i, _e, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_NINJA_BOY_SHIGEKI] = {
        .partyFlags = 0,
        .trainerClass = CLASS_NINJA_BOY,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_NINJA_BOY,
        .trainerName = {_S, _h, _l, _g, _e, _k, _i, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_NINJA_BOY_JIN] = {
        .partyFlags = 0,
        .trainerClass = CLASS_NINJA_BOY,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_NINJA_BOY,
        .trainerName = {_J, _i, _n, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_NINJA_GIRL_AOI] = {
        .partyFlags = 0,
        .trainerClass = CLASS_NINJA_GIRL,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_NINJA_GIRL,
        .trainerName = {_A, _o, _i, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_NINJA_GIRL_ATSU] = {
        .partyFlags = 0,
        .trainerClass = CLASS_NINJA_GIRL,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_NINJA_GIRL,
        .trainerName = {_A, _t, _s, _u, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_NINJA_GIRL_FUMIKA] = {
        .partyFlags = 0,
        .trainerClass = CLASS_NINJA_GIRL,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_NINJA_GIRL,
        .trainerName = {_F, _u, _m, _i, _k, _a, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_HEX_MANIAC_LYNN] = {
        .partyFlags = 0,
        .trainerClass = CLASS_HEX_MANIAC,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_HEX_MANIAC,
        .trainerName = {_L, _y, _n, _n, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_PSYCHIC_M_CRISS] = {
        .partyFlags = 0,
        .trainerClass = CLASS_PSYCHIC,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_PSYCHIC_M,
        .trainerName = {_C, _r, _i, _s, _s, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SCIENTIST_LOWELL] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SCIENTIST,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SCIENTIST_M,
        .trainerName = {_L, _o, _w, _e, _l, _l, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SCIENTIST_DANIEL] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SCIENTIST,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SCIENTIST_M,
        .trainerName = {_D, _a, _n, _i, _e, _l, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SCIENTIST_LINDEN] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SCIENTIST,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SCIENTIST_M,
        .trainerName = {_L, _i, _n, _d, _e, _n, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SUPER_NERD_WALDO] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SUPER_NERD,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SUPER_NERD,
        .trainerName = {_W, _a, _l, _d, _o, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_SUPER_NERD_MERLE] = {
        .partyFlags = 0,
        .trainerClass = CLASS_SUPER_NERD,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_SUPER_NERD,
        .trainerName = {_M, _e, _r, _l, _e, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_ACE_TRAINER_M_ARABELLA] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES,
        .trainerClass = CLASS_ACE_TRAINER,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_ACETRAINER_M,
        .trainerName = {_A, _r, _a, _b, _e, _l, _l, _a, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_ACE_TRAINER_F_SALMA] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES,
        .trainerClass = CLASS_ACE_TRAINER,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_ACETRAINER_F,
        .trainerName = {_S, _a, _l, _m, _a, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
    ...
    [TRAINER_DOUBLE_TEAM_DEX_AND_DEBB] = {
        .partyFlags = PARTY_FLAG_CUSTOM_MOVES,
        .trainerClass = CLASS_ACE_COUPLE,
        .encounterMusic = TRAINER_ENCOUNTER_MUSIC_FEMALE,
        .trainerPic = TRAINER_PIC_ACE_COUPLE,
        .trainerName = {_D, _e, _x, _AMPERSAND, _D, _e, _b, _b, _END},
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = AI_SCRIPT_SETUP_FIRST_TURN | AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_CHECK_GOOD_MOVE | AI_SCRIPT_TRY_TO_FAINT,
        .partySize = NELEMS(sParty_dummy),
