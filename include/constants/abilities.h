...
#define ABILITY_SANDSTREAM 0x2D//Also ABILITY_SANDSPIT
...
#define ABILITY_SANDSPIT ABILITY_SANDSTREAM
#define ABILITY_MEGA_SOL ABILITY_BALLFETCH //Jus needed a base ability that does basically nothing, but doesn't popup anything
#define ABILITY_SHARPNESS ABILITY_STRONGJAW 
