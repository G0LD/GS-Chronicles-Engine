...
extern const u8 Brock_MugshotTiles[];
extern const u8 Brock_MugshotPal[];
extern const u8 Misty_MugshotTiles[];
extern const u8 Misty_MugshotPal[];
extern const u8 LtSurge_MugshotTiles[];
extern const u8 LtSurge_MugshotPal[];
extern const u8 Erika_MugshotTiles[];
extern const u8 Erika_MugshotPal[];
extern const u8 Janine_MugshotTiles[];
extern const u8 Janine_MugshotPal[];
extern const u8 Sabrina_MugshotTiles[];
extern const u8 Sabrina_MugshotPal[];
extern const u8 Blaine_MugshotTiles[];
extern const u8 Blaine_MugshotPal[];
extern const u8 Blue_MugshotTiles[];
extern const u8 Blue_MugshotPal[];
extern const u8 Bruno_MugshotTiles[];
extern const u8 Bruno_MugshotPal[];
extern const u8 Agatha_MugshotTiles[];
extern const u8 Agatha_MugshotPal[];
extern const u8 Lance_MugshotTiles[];
extern const u8 Lance_MugshotPal[];
extern const u8 Red_MugshotTiles[];
extern const u8 Red_MugshotPal[];
