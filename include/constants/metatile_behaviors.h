...
#define MB_CYCLING_ROAD_PULL_DOWN_GRASS 0xA9

//Taken from Emerald:
#define MB_MUDDY_SLOPE 0xAA //Slope only for bike on turbo boost
#define MB_BUMPY_SLOPE 0xAB
#define MB_CRACKED_FLOOR 0xAC //Sky Pillar floor
#define MB_ISOLATED_VERTICAL_RAIL 0xAD
#define MB_ISOLATED_HORIZONTAL_RAIL 0xAE
#define MB_VERTICAL_RAIL 0xAF
#define MB_HORIZONTAL_RAIL 0xB6
