...
.equ MOVE_TORRENTSCALES, 0x2FF
.equ MOVE_COLOSSALJAW, 0x300
.equ MOVE_MAGMAGEYSER, 0x301
.equ MOVE_LAVAEDGESTORM, 0x302
.equ MOVE_SOLARCANNON, 0x303
.equ MOVE_AROMABLAST, 0x304
.equ MOVE_STARDUSTPUNCH, 0x305

.equ MOVE_RAGEFIST, 0x306
.equ MOVE_TWINBEAM, 0x307
.equ MOVE_HYPERDRILL, 0x308
.equ MOVE_KOWTOWCLEAVE, 0x309
.equ MOVE_RAGINGBULL, 0x30A
.equ MOVE_FREE1, 0x30B
.equ MOVE_FREE2, 0x30C
.equ MOVE_GLINTINGFANGS, 0x30D

.equ MOVE_BREAKNECK_BLITZ_P, 0x30E
.equ MOVE_BREAKNECK_BLITZ_S, 0x30F
.equ MOVE_ALL_OUT_PUMMELING_P, 0x310
.equ MOVE_ALL_OUT_PUMMELING_S, 0x311
.equ MOVE_SUPERSONIC_SKYSTRIKE_P, 0x312
.equ MOVE_SUPERSONIC_SKYSTRIKE_S, 0x313
.equ MOVE_ACID_DOWNPOUR_P, 0x314
.equ MOVE_ACID_DOWNPOUR_S, 0x315
.equ MOVE_TECTONIC_RAGE_P, 0x316
.equ MOVE_TECTONIC_RAGE_S, 0x317
.equ MOVE_CONTINENTAL_CRUSH_P, 0x318
.equ MOVE_CONTINENTAL_CRUSH_S, 0x319
.equ MOVE_SAVAGE_SPIN_OUT_P, 0x31A
.equ MOVE_SAVAGE_SPIN_OUT_S, 0x31B
.equ MOVE_NEVER_ENDING_NIGHTMARE_P, 0x31C
.equ MOVE_NEVER_ENDING_NIGHTMARE_S, 0x31D
.equ MOVE_CORKSCREW_CRASH_P, 0x31E
.equ MOVE_CORKSCREW_CRASH_S, 0x31F
.equ MOVE_INFERNO_OVERDRIVE_P, 0x320
.equ MOVE_INFERNO_OVERDRIVE_S, 0x321
.equ MOVE_HYDRO_VORTEX_P, 0x322
.equ MOVE_HYDRO_VORTEX_S, 0x323
.equ MOVE_BLOOM_DOOM_P, 0x324
.equ MOVE_BLOOM_DOOM_S, 0x325
.equ MOVE_GIGAVOLT_HAVOC_P, 0x326
.equ MOVE_GIGAVOLT_HAVOC_S, 0x327
.equ MOVE_SHATTERED_PSYCHE_P, 0x329
.equ MOVE_SHATTERED_PSYCHE_S, 0x32A
.equ MOVE_SUBZERO_SLAMMER_P, 0x32B
.equ MOVE_SUBZERO_SLAMMER_S, 0x32C
.equ MOVE_DEVASTATING_DRAKE_P, 0x32D
.equ MOVE_DEVASTATING_DRAKE_S, 0x32E
.equ MOVE_BLACK_HOLE_ECLIPSE_P, 0x32F
.equ MOVE_BLACK_HOLE_ECLIPSE_S, 0x330
.equ MOVE_TWINKLE_TACKLE_P, 0x331
.equ MOVE_TWINKLE_TACKLE_S, 0x332

.equ MOVE_CATASTROPIKA, 0x333
.equ MOVE_10000000_VOLT_THUNDERBOLT, 0x334
.equ MOVE_STOKED_SPARKSURFER, 0x335
.equ MOVE_EXTREME_EVOBOOST, 0x336
.equ MOVE_PULVERIZING_PANCAKE, 0x337
.equ MOVE_GENESIS_SUPERNOVA, 0x338
.equ MOVE_SINISTER_ARROW_RAID, 0x339
.equ MOVE_MALICIOUS_MOONSAULT, 0x33A
.equ MOVE_OCEANIC_OPERETTA, 0x33B
.equ MOVE_SPLINTERED_STORMSHARDS, 0x33C
.equ MOVE_LETS_SNUGGLE_FOREVER, 0x33D
.equ MOVE_CLANGOROUS_SOULBLAZE, 0x33E
.equ MOVE_GUARDIAN_OF_ALOLA, 0x33F
.equ MOVE_SEARING_SUNRAZE_SMASH, 0x340
.equ MOVE_MENACING_MOONRAZE_MAELSTROM, 0x341
.equ MOVE_LIGHT_THAT_BURNS_THE_SKY, 0x342
.equ MOVE_SOUL_STEALING_7_STAR_STRIKE, 0x343
...
.equ SPECIES_ANNIHILAPE, 0x4EC
.equ SPECIES_FARIGIRAF, 0x4ED
.equ SPECIES_DUDUNSPARCE, 0x4EE
.equ SPECIES_KINGAMBIT, 0x4EF
.equ SPECIES_TAUROS_P, 0x4F0
.equ SPECIES_TAUROS_BLAZE_P, 0x4F1
.equ SPECIES_TAUROS_AQUA_P, 0x4F2
.equ SPECIES_WOOPER_P, 0x4F3
.equ SPECIES_CLODSIRE, 0x4F4
.equ SPECIES_DUDUNSPARCE_THREE, 0x4F5

.equ SPECIES_MEGANIUM_MEGA, 0x4F6
.equ SPECIES_TYPHLOSION_MEGA, 0x4F7
.equ SPECIES_FERALIGATR_MEGA, 0x4F8
.equ SPECIES_LUXRAY_MEGA, 0x4F9

.equ SPECIES_BELLSPROUT_RIDE, 0x4FA
.equ SPECIES_SEAKING_RIDE, 0x4FB
.equ SPECIES_MACHOKE_RIDE, 0x4FC
.equ SPECIES_ABRA_RIDE, 0x4FD
.equ SPECIES_PIDGEOT_RIDE, 0x4FE

.equ SPECIES_VENUSAUR_GIGA, 0x4FF
.equ SPECIES_CHARIZARD_GIGA, 0x500
.equ SPECIES_BLASTOISE_GIGA, 0x501
.equ SPECIES_BUTTERFREE_GIGA, 0x502
.equ SPECIES_PIKACHU_GIGA, 0x503
.equ SPECIES_MEOWTH_GIGA, 0x504
.equ SPECIES_MACHAMP_GIGA, 0x505
.equ SPECIES_GENGAR_GIGA, 0x506
.equ SPECIES_KINGLER_GIGA, 0x507
.equ SPECIES_LAPRAS_GIGA, 0x508
.equ SPECIES_EEVEE_GIGA, 0x509
.equ SPECIES_SNORLAX_GIGA, 0x50A
.equ SPECIES_GARBODOR_GIGA, 0x50B
.equ SPECIES_MELMETAL_GIGA, 0x50C
.equ SPECIES_RILLABOOM_GIGA, 0x50D
.equ SPECIES_CINDERACE_GIGA, 0x50E
.equ SPECIES_INTELEON_GIGA, 0x50F
.equ SPECIES_CORVIKNIGHT_GIGA, 0x510
.equ SPECIES_ORBEETLE_GIGA, 0x511
.equ SPECIES_DREDNAW_GIGA, 0x512
.equ SPECIES_COALOSSAL_GIGA, 0x513
.equ SPECIES_FLAPPLE_GIGA, 0x514
.equ SPECIES_APPLETUN_GIGA, 0x515
.equ SPECIES_SANDACONDA_GIGA, 0x516
.equ SPECIES_TOXTRICITY_GIGA, 0x517
.equ SPECIES_TOXTRICITY_LOW_KEY_GIGA, 0x518
.equ SPECIES_CENTISKORCH_GIGA, 0x519
.equ SPECIES_HATTERENE_GIGA, 0x51A
.equ SPECIES_GRIMMSNARL_GIGA, 0x51B
.equ SPECIES_ALCREMIE_GIGA, 0x51C
.equ SPECIES_COPPERAJAH_GIGA, 0x51D
.equ SPECIES_DURALUDON_GIGA, 0x51E
.equ SPECIES_URSHIFU_SINGLE_GIGA, 0x51F
.equ SPECIES_URSHIFU_RAPID_GIGA, 0x520
...
.equ ITEM_FOCUS_SASH, 0x36
.equ ITEM_LIFE_ORB, 0xE4
.equ ITEM_TOXIC_ORB, 0x38
.equ ITEM_FLAME_ORB, 0x39
.equ ITEM_BLACK_SLUDGE, 0xE6
.equ ITEM_ASSAULT_VEST, 0xE7
.equ ITEM_EVIOLITE, 0xE8

.equ ITEM_CHOICE_BAND, 0xBA
.equ ITEM_CHOICE_SPECS, 0xE2
.equ ITEM_CHOICE_SCARF, 0xE3
...
@;Mints
.equ ITEM_RED_MINT, 0xF7
.equ ITEM_BLUE_MINT, 0xF8
.equ ITEM_AZURE_MINT, 0xF9
.equ ITEM_ROSEATE_MINT, 0xFA
.equ ITEM_GREEN_MINT, 0xFB
.equ ITEM_YELLOW_MINT, 0xFC
