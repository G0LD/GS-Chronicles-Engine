...
#define INGAME_TRADE_SANDSHREW_A   0
#define INGAME_TRADE_TAUROS_P      1
...
#define INGAME_TRADE_TAUROS_B      9
#define INGAME_TRADE_TAUROS_A     10
#define INGAME_TRADE_SPIRITOMB    11
