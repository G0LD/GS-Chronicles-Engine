...
//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P 0x30A
#define MOVE_BREAKNECK_BLITZ_S 0x30B
#define MOVE_ALL_OUT_PUMMELING_P 0x30C
#define MOVE_ALL_OUT_PUMMELING_S 0x30D
#define MOVE_SUPERSONIC_SKYSTRIKE_P 0x30E
#define MOVE_SUPERSONIC_SKYSTRIKE_S 0x30F
#define MOVE_ACID_DOWNPOUR_P 0x310
#define MOVE_ACID_DOWNPOUR_S 0x311
#define MOVE_TECTONIC_RAGE_P 0x312
#define MOVE_TECTONIC_RAGE_S 0x313
#define MOVE_CONTINENTAL_CRUSH_P 0x314
#define MOVE_CONTINENTAL_CRUSH_S 0x315
#define MOVE_SAVAGE_SPIN_OUT_P 0x316
#define MOVE_SAVAGE_SPIN_OUT_S 0x317
#define MOVE_NEVER_ENDING_NIGHTMARE_P 0x318
#define MOVE_NEVER_ENDING_NIGHTMARE_S 0x319
#define MOVE_CORKSCREW_CRASH_P 0x31A
#define MOVE_CORKSCREW_CRASH_S 0x31B
#define MOVE_INFERNO_OVERDRIVE_P 0x31C
#define MOVE_INFERNO_OVERDRIVE_S 0x31D
#define MOVE_HYDRO_VORTEX_P 0x31E
#define MOVE_HYDRO_VORTEX_S 0x31F
#define MOVE_BLOOM_DOOM_P 0x320
#define MOVE_BLOOM_DOOM_S 0x321
#define MOVE_GIGAVOLT_HAVOC_P 0x322
#define MOVE_GIGAVOLT_HAVOC_S 0x323
#define MOVE_SHATTERED_PSYCHE_P 0x324
#define MOVE_SHATTERED_PSYCHE_S 0x325
#define MOVE_SUBZERO_SLAMMER_P 0x326
#define MOVE_SUBZERO_SLAMMER_S 0x327
#define MOVE_DEVASTATING_DRAKE_P 0x328
#define MOVE_DEVASTATING_DRAKE_S 0x329
#define MOVE_BLACK_HOLE_ECLIPSE_P 0x32A
#define MOVE_BLACK_HOLE_ECLIPSE_S 0x32B
#define MOVE_TWINKLE_TACKLE_P 0x32C
#define MOVE_TWINKLE_TACKLE_S 0x32D

#define MOVE_CATASTROPIKA 0x32E
#define MOVE_10000000_VOLT_THUNDERBOLT 0x32F
#define MOVE_STOKED_SPARKSURFER 0x330 //Paralyze, Target
#define MOVE_EXTREME_EVOBOOST 0x331 //Double, Ancient, Power
#define MOVE_PULVERIZING_PANCAKE 0x332
#define MOVE_GENESIS_SUPERNOVA 0x333 //Sets, up, Psychic, Terrain
#define MOVE_SINISTER_ARROW_RAID 0x334
#define MOVE_MALICIOUS_MOONSAULT 0x335
#define MOVE_OCEANIC_OPERETTA 0x336
#define MOVE_SPLINTERED_STORMSHARDS 0x337 //Removes, Terrain
#define MOVE_LETS_SNUGGLE_FOREVER 0x338
#define MOVE_CLANGOROUS_SOULBLAZE 0x339 //Ancient, Power
#define MOVE_GUARDIAN_OF_ALOLA 0x33A
#define MOVE_SEARING_SUNRAZE_SMASH 0x33B
#define MOVE_MENACING_MOONRAZE_MAELSTROM 0x33C
#define MOVE_LIGHT_THAT_BURNS_THE_SKY 0x33D
#define MOVE_SOUL_STEALING_7_STAR_STRIKE 0x33E

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD 0x33F
#define MOVE_MAX_STRIKE_P 0x340
#define MOVE_MAX_STRIKE_S 0x341
#define MOVE_MAX_KNUCKLE_P 0x342
#define MOVE_MAX_KNUCKLE_S 0x343
#define MOVE_MAX_AIRSTREAM_P 0x344
#define MOVE_MAX_AIRSTREAM_S 0x345
#define MOVE_MAX_OOZE_P 0x346
#define MOVE_MAX_OOZE_S 0x347
#define MOVE_MAX_QUAKE_P 0x348
#define MOVE_MAX_QUAKE_S 0x349
#define MOVE_MAX_ROCKFALL_P 0x34A
#define MOVE_MAX_ROCKFALL_S 0x34B
#define MOVE_MAX_FLUTTERBY_P 0x34C
#define MOVE_MAX_FLUTTERBY_S 0x34D
#define MOVE_MAX_PHANTASM_P 0x34E
#define MOVE_MAX_PHANTASM_S 0x34F
#define MOVE_MAX_STEELSPIKE_P 0x350
#define MOVE_MAX_STEELSPIKE_S 0x351
#define MOVE_MAX_FLARE_P 0x352
#define MOVE_MAX_FLARE_S 0x353
#define MOVE_MAX_GEYSER_P 0x354
#define MOVE_MAX_GEYSER_S 0x355
#define MOVE_MAX_OVERGROWTH_P 0x356
#define MOVE_MAX_OVERGROWTH_S 0x357
#define MOVE_MAX_LIGHTNING_P 0x358
#define MOVE_MAX_LIGHTNING_S 0x359
#define MOVE_MAX_MINDSTORM_P 0x35A
#define MOVE_MAX_MINDSTORM_S 0x35B
#define MOVE_MAX_HAILSTORM_P 0x35C
#define MOVE_MAX_HAILSTORM_S 0x35D
#define MOVE_MAX_WYRMWIND_P 0x35E
#define MOVE_MAX_WYRMWIND_S 0x35F
#define MOVE_MAX_DARKNESS_P 0x360
#define MOVE_MAX_DARKNESS_S 0x361
#define MOVE_MAX_STARFALL_P 0x362
#define MOVE_MAX_STARFALL_S 0x363
#define MOVE_G_MAX_VINE_LASH_P 0x364
#define MOVE_G_MAX_VINE_LASH_S 0x365
#define MOVE_G_MAX_WILDFIRE_P 0x366
#define MOVE_G_MAX_WILDFIRE_S 0x367
#define MOVE_G_MAX_CANNONADE_P 0x368
#define MOVE_G_MAX_CANNONADE_S 0x369
#define MOVE_G_MAX_BEFUDDLE_P 0x36A
#define MOVE_G_MAX_BEFUDDLE_S 0x36B
#define MOVE_G_MAX_VOLT_CRASH_P 0x36C
#define MOVE_G_MAX_VOLT_CRASH_S 0x36D
#define MOVE_G_MAX_GOLD_RUSH_P 0x36E
#define MOVE_G_MAX_GOLD_RUSH_S 0x36F
#define MOVE_G_MAX_CHI_STRIKE_P 0x370
#define MOVE_G_MAX_CHI_STRIKE_S 0x371
#define MOVE_G_MAX_TERROR_P 0x372
#define MOVE_G_MAX_TERROR_S 0x373
#define MOVE_G_MAX_FOAM_BURST_P 0x374
#define MOVE_G_MAX_FOAM_BURST_S 0x375
#define MOVE_G_MAX_RESONANCE_P 0x376
#define MOVE_G_MAX_RESONANCE_S 0x377
#define MOVE_G_MAX_CUDDLE_P 0x378
#define MOVE_G_MAX_CUDDLE_S 0x379
#define MOVE_G_MAX_REPLENISH_P 0x37A
#define MOVE_G_MAX_REPLENISH_S 0x37B
#define MOVE_G_MAX_MALODOR_P 0x37C
#define MOVE_G_MAX_MALODOR_S 0x37D
#define MOVE_G_MAX_MELTDOWN_P 0x37E
#define MOVE_G_MAX_MELTDOWN_S 0x37F
#define MOVE_G_MAX_DRUM_SOLO_P 0x380
#define MOVE_G_MAX_DRUM_SOLO_S 0x381
#define MOVE_G_MAX_FIREBALL_P 0x382
#define MOVE_G_MAX_FIREBALL_S 0x383
#define MOVE_G_MAX_HYDROSNIPE_P 0x384
#define MOVE_G_MAX_HYDROSNIPE_S 0x385
#define MOVE_G_MAX_WIND_RAGE_P 0x386
#define MOVE_G_MAX_WIND_RAGE_S 0x387
#define MOVE_G_MAX_GRAVITAS_P 0x388
#define MOVE_G_MAX_GRAVITAS_S 0x389
#define MOVE_G_MAX_STONESURGE_P 0x38A
#define MOVE_G_MAX_STONESURGE_S 0x38B
#define MOVE_G_MAX_VOLCALITH_P 0x38C
#define MOVE_G_MAX_VOLCALITH_S 0x38D
#define MOVE_G_MAX_TARTNESS_P 0x38E
#define MOVE_G_MAX_TARTNESS_S 0x38F
#define MOVE_G_MAX_SWEETNESS_P 0x390
#define MOVE_G_MAX_SWEETNESS_S 0x391
#define MOVE_G_MAX_SANDBLAST_P 0x392
#define MOVE_G_MAX_SANDBLAST_S 0x393
#define MOVE_G_MAX_STUN_SHOCK_P 0x394
#define MOVE_G_MAX_STUN_SHOCK_S 0x395
#define MOVE_G_MAX_CENTIFERNO_P 0x396
#define MOVE_G_MAX_CENTIFERNO_S 0x397
#define MOVE_G_MAX_SMITE_P 0x398
#define MOVE_G_MAX_SMITE_S 0x399
#define MOVE_G_MAX_SNOOZE_P 0x39A
#define MOVE_G_MAX_SNOOZE_S 0x39B
#define MOVE_G_MAX_FINALE_P 0x39C
#define MOVE_G_MAX_FINALE_S 0x39D
#define MOVE_G_MAX_STEELSURGE_P 0x39E
#define MOVE_G_MAX_STEELSURGE_S 0x39F
#define MOVE_G_MAX_DEPLETION_P 0x3A0
#define MOVE_G_MAX_DEPLETION_S 0x3A1
#define MOVE_G_MAX_ONE_BLOW_P 0x3A2
#define MOVE_G_MAX_ONE_BLOW_S 0x3A3
#define MOVE_G_MAX_RAPID_FLOW_P 0x3A4
#define MOVE_G_MAX_RAPID_FLOW_S 0x3A5
